...
object NetworkModule {
    ...
    fun provideRetrofit(
        ...
        return Retrofit.Builder()
            .baseUrl("https://api.example.com/") // Base URL, will be overridden by @Url
            .client(okHttpClient)
    ...
    @Provides
    @Singleton
    fun provideParserApiService(retrofit: Retrofit): ParserApiService {
        return retrofit.create(ParserApiService::class.java)
    }
    
    @Provides
    @Singleton
    fun providePlaybackApiService(retrofit: Retrofit): PlaybackApiService {
